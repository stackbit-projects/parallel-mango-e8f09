...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fde8f09488d050015e1166e
...
To start editing your site, you can use the Sanity interface at https://parallel-mango-e8f09.sanity.studio/.
...
Generated at `2020-12-19T23:42:02.188Z` by Stackbit version `0.3.40`.